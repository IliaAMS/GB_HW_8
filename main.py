# День добрый!
# Запарился делать красоту с отступами и проверками)))
# Буду честен, кое что, по мелочи, подглядел. До флага сам допёр - проходил в другом месте) И, если уж совсем откровенно, я прос... профукал две недели ,а это всё, можно сказать, за пару дней написал...
# Есть ощущение, что с удалением контакта можно как-то подругому, без полного переписывания, но не понимаю как.
# Ещё в копировании, кажеться намудрил с кучей открытиев файла, но без этого ломалось всё.
